                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="font-medium">Project 3</div>
                          </TableCell>
                          <TableCell className="hidden sm:table-cell">
                            <Badge className="text-xs" variant="outline">
                              Pending
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="font-medium">Project 4</div>
                          </TableCell>
                          <TableCell className="hidden sm:table-cell">
                            <Badge className="text-xs" variant="outline">
                              Complete
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="font-medium">Project 5</div>
                          </TableCell>
                          <TableCell className="hidden sm:table-cell">
                            <Badge className="text-xs" variant="outline">
                              Working on
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="font-medium">Project 7</div>
                          </TableCell>
                          <TableCell className="hidden sm:table-cell">
                            <Badge className="text-xs" variant="outline">
                              Working on
